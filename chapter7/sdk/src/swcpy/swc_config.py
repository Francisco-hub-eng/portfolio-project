...
class SWCConfig:
    ...
    def __init__(
        ...
        swc_bulk_format:
            If bulk files should be in csv or paquet format.
        """
        ...
        if not self.swc_base_url:
            raise ValueError("Base URL is required. Set SWC_API_BASE_URL environtment variable.")
    ...
    def __str__(self):
        """ Stringigy function to return contents of config object for logging"""
